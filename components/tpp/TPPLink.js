    ...
    return (
        <div className="h-screen w-screen fixed  overflow-auto">
            <div className="w-full md:h-full flex flex-wrap">
                ...
                <div className="mt-16 md:mx-0 -ml-4 md:ml-0 md:mt-0 md:h-screen mb-4 md:mb-0 w-full lg:h-full lg:w-1/2 flex justify-center items-center">
                    ...
                    <div className="max-w-xl md:pl-32">
                        ...
                        <div className="flex justify-between mt-3">
                            <FacebookShareButton url={rellink}>
                                <FacebookIcon size={32} round={true}></FacebookIcon>
                            </FacebookShareButton>
                            <TwitterShareButton url={rellink}>
                                <TwitterIcon size={32} round={true}></TwitterIcon>
                            </TwitterShareButton>
                            <TelegramShareButton url={rellink}>
                                <TelegramIcon size={32} round={true}></TelegramIcon>
                            </TelegramShareButton>
                            <WhatsappShareButton url={rellink}>
                                <WhatsappIcon size={32} round={true}></WhatsappIcon>
                            </WhatsappShareButton>
                            <PinterestShareButton url={rellink}>
                                <PinterestIcon size={32} round={true}></PinterestIcon>
                            </PinterestShareButton>
                            <RedditShareButton url={rellink}>
                                <RedditIcon size={32} round={true}></RedditIcon>
                            </RedditShareButton>
                            <LinkedinShareButton url={rellink}>
                ...
                <div className="h-screen w-full lg:h-full lg:w-1/2">
                    <div className="h-full md:w-4/5 lg:w-3/4 bg-no-repeat bg-center px-4 md:px-12 pt- md:overflow-auto">
                        <div className="-mt-16 md:mt-32">
                            <div className="flex flex-row items-center justify-between m-2">
                                <div className="animate__animated animate__backInDown flex flex-col items-center mx-auto">

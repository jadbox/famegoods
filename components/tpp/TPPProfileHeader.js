    ...
    return (
        <div className="flex flex-auto">
            ...
            <div className="flex flex-col font-mont">
                <p className="ml-4 text-extrabold tracking-wide text-black text-lg align-text-top font-mont align-middle capitalize font-karla">
                    Jennifer Tran
                </p>
                <p className="ml-4 text-extrabold tracking-wide text-black text-md align-text-top font-mont align-middle capitalize font-karla">
                    6 minutes ago
                </p>
            </div>
        </div>

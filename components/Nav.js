  ...
  return (
    ...
    >
      <BottomNavigationAction
        value="1"
        icon={<Icon icon={streamSolid} color="black" height="2em" />}
      />
      <BottomNavigationAction
        value="2"
        icon={<Icon icon={compassIcon} color="black" height="2em" />}
      />
      <BottomNavigationAction
        value="3"
        icon={<Icon icon={shoppingBagSolid} color="black" height="2em" />}
      />
      <BottomNavigationAction
        value="3"
        icon={<Icon icon={userIcon} color="black" height="2em" />}
      />
    </BottomNavigation>
  );
}

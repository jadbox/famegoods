...
// For testing
  ...
  return (
    <div className="flex mx-5 h-screen">
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg bg-cover"
      ...
      >
        ...
        <div className="px-6 py-4">
          <button className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded-full mr-2" onClick={onClick}>
            3 $TINGLES
          </button>

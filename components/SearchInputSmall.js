...
export default function SearchInputSmall() {
    ...
    return (
        <div className="h-10 w-full mb-6 cursor-pointer">
            ...
            <input typeName="search" className="bg-purple-white w-full cursor-pointer shadow-md hover:shadow focus:shadow h-10 text-gray-400 rounded-lg border-solid border-2 outline-none focus:text-black p-4 pl-12  text-sm tracking-wide items-stretch" placeholder="Creator, $Token or Content" />
        </div>

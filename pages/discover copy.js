                                ...
                                <table className="min-w-full leading-normal">
                                    ...
                                    <tbody>
                                        <tr className="hover:shadow-lg hover:border-2">
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-3">
                                                        <p className="text-gray-900 text-xs md:text-base whitespace-no-wrap">
                                                            Vera Carpenter
                                            </p>
                                                    </div>
                                                </div>
                                            ...
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p className="text-gray-900 text-xs md:text-base whitespace-no-wrap">$Vera</p>
                                            </td>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                        ...
                                        <tr>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-3">
                                                        <p className="text-gray-900 whitespace-no-wrap text-xs md:text-base">
                                                            Blake Bowman
                                            </p>
                                                    </div>
                                                </div>
                                            ...
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p className="text-gray-900 whitespace-no-wrap text-xs md:text-base">$Blake</p>
                                            </td>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                                    className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p className="text-gray-900 whitespace-no-wrap text-xs md:text-base">$Dana</p>
                                            </td>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                                    className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-5 py-5 bg-white text-sm">
                                                <p className="text-gray-900 whitespace-no-wrap text-xs md:text-base">$Alonzo</p>
                                            </td>
                                            <td className="px-5 py-5 bg-white text-sm">
                                                <span
                                                    className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
